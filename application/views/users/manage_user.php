...
<form method="post" enctype="multipart/form-data" action="<?php echo base_url()."index.php/user/manage_user/src"; ?>" accept-charset="utf-8">
    <label for="tglsedia"><center>Cari User</center></label>
	<input type="text" placeholder="Masukkan Nomor Induk User" name="nis" required>
