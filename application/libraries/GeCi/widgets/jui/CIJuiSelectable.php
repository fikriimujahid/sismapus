...
/**
 * CIJuiSelectable Class
 *
 * @package			CIJuiSelectable
...
class CIJuiSelectable extends CIJuiWidget
{
	...
	{		
		...
		CIHtml::registerScriptBottom("jQuery('#". $this->getId() ."').selectable(". CIJavaScript::encode($this->options) .")"); 
	}
}