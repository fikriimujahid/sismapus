...
/**
 * CIJuiDraggable Class
 *
 * @package			CIJuiDraggable
...
class CIJuiDraggable extends CIJuiWidget
{
	...
	{		
		...
		CIHtml::registerScriptBottom("jQuery('#". $this->getId() ."').draggable(". CIJavaScript::encode($this->options) .");"); 
	}
}