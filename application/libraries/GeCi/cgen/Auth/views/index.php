...
<div class="row-fluid">
	<div class="span12">
		...
		<?php CGAuthCode::getInstance()->getMessage('success'); ?>
		<form method="POST">
			...
			<?php if($tampil=='ya'): ?>
				<div class="alert alert-error  fade in" style="font-size:90%">
					...
					<?php echo "<a href='javascript:void(0);' onclick='jQuery(\"#dlg_index\").dialog(\"open\");'>$show_index</a>"; ?><br />
					<?php echo "<a href='javascript:void(0);' onclick='jQuery(\"#dlg_login\").dialog(\"open\");'>$show_login</a>"; ?><br />
					<?php echo "<a href='javascript:void(0);' onclick='jQuery(\"#dlg_model\").dialog(\"open\");'>$show_model</a>"; ?>
				</div>
			<?php endif; ?>
