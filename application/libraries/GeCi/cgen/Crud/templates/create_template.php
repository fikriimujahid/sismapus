<?php echo "<?php\n"; ?>
/**
 * Create <?php echo ucwords($controllername)."\n"; ?>
 *
...
<!-- Title -->
<h1>Create <?php echo ucwords(str_replace('_',' ',$controllername)); ?></h1>
...
<?php foreach($fieldCreate as $row): ?><?php echo "\n"; ?>
...
<div class="control-group">
	...
	<div class="controls">
		<?php echo "<?php"; ?> echo CIHtml::<?php echo $row['input']; ?><?php echo $row['type']; ?>(array(
			...
			'value'=>CIHtml::setValue('<?php echo $row['field']; ?>'),
...
<div class="form-actions">
	<?php echo "<?php"; ?> echo CIHtml::button(array(
		...
		'content'=>'<i class="icon-white icon-file"></i> Create'
	)); ?>
</div>
...
<?php echo "<?php"; ?> $this->geci->load('widgets.CIJqValidation')->reg(array(
    'id'=>'<?php echo $modelname; ?>_form',
    'options'=>array(
        'rules'=>array(<?php foreach($validationCreate as $row): ?><?php echo "\n\t\t\t"; ?>
